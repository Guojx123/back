  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        MultiSelectionWidget("上边距", [10.0, 20.0, 30.0, 40.0, 50.0], [10, 20, 30, 40, 50], (value) {
          setState(() => topSize = value);
        }),
        MultiSelectionWidget("左边距", [10.0, 20.0, 30.0, 40.0, 50.0], [10, 20, 30, 40, 50], (value) {
          setState(() => leftSize = value);
        }),
        MultiSelectionWidget("右边距", [10.0, 20.0, 30.0, 40.0, 50.0], [10, 20, 30, 40, 50], (value) {
          setState(() => rightSize = value);
        }),
        MultiSelectionWidget("下边距", [10.0, 20.0, 30.0, 40.0, 50.0], [10, 20, 30, 40, 50], (value) {
