...
List<DemoItem> buildDesignPatternsDemoItems(String codePath) {
  return [
    DemoItem(
      ...
      buildRoute: (context) => BaseWidget('单例模式', codePath + 'singleton_create', SingletonPage()),
    ),
    DemoItem(
      icon: Icons.design_services,
      title: '工厂模式-创建型',
      ...
      keyword: 'factory',
      documentationUrl: 'https://flutter.cn/',
      buildRoute: (context) => BaseWidget('工厂模式', codePath + 'factory_create', FactoryPage()),
    ),
    DemoItem(
      icon: Icons.design_services,
      title: '建造者模式-创建型',
      ...
      keyword: 'builder',
      documentationUrl: 'https://flutter.cn/',
      buildRoute: (context) => BaseWidget('建造者模式', codePath + 'builder_create', BuilderPage()),
    ),
    DemoItem(
      icon: Icons.design_services,
      title: '适配器模式-结构型',
      ...
      keyword: 'adapter',
      documentationUrl: 'https://flutter.cn/',
      buildRoute: (context) => BaseWidget('适配器模式', codePath + 'adapter', AdapterPage()),
    ),
    DemoItem(
      icon: Icons.design_services,
      title: '桥接模式-结构型',
      ...
      keyword: 'bridge',
      documentationUrl: 'https://flutter.cn/',
      buildRoute: (context) => BaseWidget('桥接模式', codePath + 'bridge', BridgePage()),
    ),
  ];
}
