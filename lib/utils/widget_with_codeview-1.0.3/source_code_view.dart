...
import 'package:back/Utils/animated_floatactionbuttons-0.1.0/animated_floatactionbuttons.dart';
        ...
        child: SingleChildScrollView(
          child: SingleChildScrollView(
            ...
            child: SelectableText.rich(
              ...
              style:
                  DefaultTextStyle.of(context).style.apply(fontSizeFactor: this._textScaleFactor),
            ),
          ),
        ),
      ),
    ...
    return <Widget>[
      ...
      if (widget.codeLink != null)
        FloatingActionButton(
          ...
          onPressed: () => url_launcher.launch(widget.codeLink ?? ''),
        ),
      FloatingActionButton(
        heroTag: null,
