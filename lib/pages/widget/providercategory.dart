                  ...
                  MaterialPageRoute(
                    builder: (context) => Scaffold(
                      body: Center(
                        child: RaisedButton(
                          onPressed: () =>
                              Provider.of<ChangeNotifyModel>(context, listen: false).increment(),
                          child: Text('add'),
                        ),
                      ),
                    ),
                  ...
                  MaterialPageRoute(
                    builder: (context) => Scaffold(
                      body: Center(
                        child: RaisedButton(
                          onPressed: () {
                            ValueNotifyModel oldModel =
                                Provider.of<ValueNotifyModel>(context, listen: false);
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => Scaffold(
                      body: Center(
                        child: RaisedButton(
                          onPressed: () => ProviderStream.getInstance().increment(),
                          child: Text('add'),
                        ),
                      ),
                    ),
...
class ProviderStream {
  ...
  factory ProviderStream.getInstance() => _getInstance();
...
Future<String> providerFuture() async {
  return await Future<String>.delayed(Duration(milliseconds: 2000))
      .then((String value) => 'xuyisheng');
}
                      ...
                      body: Center(
                        child: Column(
                          ...
                          children: <Widget>[
                            RaisedButton(
                              onPressed: () =>
                                  Provider.of<SelectorModel>(context, listen: false).increment1(),
                              child: Text('add value 1'),
                            ),
                            RaisedButton(
                              onPressed: () =>
                                  Provider.of<SelectorModel>(context, listen: false).increment2(),
