...
//        margin: EdgeInsets.only(bottom: widget.hasMarginBottom?1.5:0),
        padding: EdgeInsets.symmetric(
            vertical: widget.marginVertical != null ? widget.marginVertical : 12, horizontal: 15),
        decoration: BoxDecoration(
          color: Colors.white,
          border: Border(
              bottom:
                  widget.hasMarginBottom ? BorderSide(color: Color(0xFFEBEBEB)) : BorderSide.none),
        ),
        child: Row(
          ...
          children: <Widget>[
            ...
            widget.contentWidget != null
                ...
                : Text(
                    ...
                    style: TextStyle(
                      color: widget.contentColor ?? const Color(0xFF999999),
                      fontSize: widget.contentColor != null ? widget.contentFontSize : 14,
                    ),
                  ),
            widget.isShowArrowIcon
                ? SizedBox(
                    width: 10,
                  )
                : Container(),
